...
(function(p,v){function C(a,b){function c(){var f=q(arguments);return f.length<d?function(){for(var a=arguments.length,b=Array(a),d=0;d<a;d++)b[d]=arguments[d];return c.apply(null,f.concat(b))}:a.apply(b||this,f)}var d=a.length;return c}function M(a){return p.createRange().createContextualFragment(a||"")}function D(a,b){return toString.call(a)===b}function I(a,b){if(k(b)){var c=0;if(h.Arraylike(a)&&!localStorage)for(;c<a.length;c++)b(a[c],c,a);else if(h.int(a)&&!l(a))for(;a!=c;)b(c++);else for(c in a)a.hasOwnProperty(c)&&
...
!0===a.__isOnce&&f.delete(a)})}()},makeHandle:function(a,d){if(!k(d))throw new TypeError("eventsys : listener needs a function");return{on:function(){x(a)?a.map(function(a){b.set(a,d)}):b.set(a,d);return this},once:function(){x(a)?a.map(function(a){b.set(a,d,!0)}):b.set(a,d,!0);return this},off:function(){x(a)?a.map(function(a){b.delete(a,d)}):b.delete(a,d);return this}}}};return b}function N(a){a||(a={});var b=aa(),c=!1;a.on=function(a,c){return b.makeHandle(a,c).on()};a.once=function(a,c){return b.makeHandle(a,
c).once()};a.off=function(a,c){return b.makeHandle(a,c).off()};a.emit=function(d){var f=arguments;if(!c&&l(d))(function(){var c=q(f,1);b.loop(d,function(b){b.apply(a,c)})})();else throw new TypeError("eventsys : you cannot emit that! "+d);};a.stopall=function(a){return c=isBool(a)?a:!0};a.defineHandle=function(b,c){c||(c=b);a[b]=function(b,d){return a[d?"once":"on"](c,b)}};return a}function J(a){a||(a={});a=N(a);var b=aa();E(a,"isObservable",O(!0));["$get","$set"].map(function(c){var f="$get"==c?
"Get":"Set";E(a,c,O(function(a,c){k(a)&&(c=a,a="*");if(!k(c))throw Error("."+a+" no function");c.prop=l(a)?a:"*";return b.makeHandle(f,c).on()}))});E(a,"get",O(function(c){if("get"!=c&&"set"!=c){var f=void 0;b.loop("Get",function(b){if("*"===b.prop||b.prop===c)f=b(c,a)});return void 0!=f?f:a[c]}return a[c]}));E(a,"set",O(C(function(c,f){var e=void 0;b.loop("Set",function(b){"*"!==b.prop&&b.prop!==c||b(c,f,a,Object.hasOwnProperty(a,c))});e=void 0!=e?e:f;n(e)&&!e.isObservable&&(e=J(e));a[c]=e;a.emit("$uberset:"+
c,e)})));for(var c in a)n(a[c])&&!a[c].isObservable&&(a[c]=J(a[c]));if("undefined"!=typeof Proxy)return new Proxy(a,{get:function(a,c){if("get"!=c&&"set"!=c){var e=void 0;b.loop("Get",function(b){if("*"===b.prop||b.prop===c)e=b(c,a)});return void 0!=e?e:Reflect.get(a,c)}return Reflect.get(a,c)},set:function(a,c,e){var A=void 0,g=!1;b.loop("Set",function(b){if("*"===b.prop||b.prop===c)g?(e=A,g=!1):g=!0,A=b(c,e,a,!Reflect.has(a,c))});A=void 0!=A?A:e;n(A)&&!A.isObservable&&(A=J(A));a.emit("$uberset:"+
c,A);return Reflect.set(a,c,A)}});console.warn("This JavaScript Environment does not support Proxy, observables need to use the .set and .get accessors to work");return a}function B(a,b){l(b)&&(b=p.querySelector(b));return h.Node(b)?b.querySelector(a):p.querySelector(a)}function G(a,b){l(b)&&(b=G(b));var c=void 0;if(h.Arraylike(b)&&1<b.length)c=[],y(b,function(b){l(b)&&(b=B(b));h.Node(b)&&(b=G(a,b),h.NodeList(b)&&c.concat(b))});else if(c=h.Node(b)?b:h.NodeList(b)?b[0]:p)if(c=c.querySelectorAll(a),
null!=c)return q(c);return null}function P(a,b,c,d){k(b)&&(c=b,b=void 0);a=G(a,b);h.Arraylike(a)&&a.forEach(c);if(d)return a}function la(a,b,c){var d=function(f){return function(d){return Q(f,a,d,b)[c||"on"]()}};return{Click:d("click"),Input:d("input"),DoubleClick:d("dblclick"),Focus:d("focus"),Blur:d("blur"),Keydown:d("keydown"),Mousemove:d("mousemove"),Mousedown:d("mousedown"),Mouseup:d("mouseup"),Mouseover:d("mouseover"),Mouseout:d("mouseout"),Mouseenter:d("mouseenter"),Mouseleave:d("mouseleave"),
Scroll:d("scroll")}}function K(a){return function(b,c){return function(d){d.keyCode===a&&b.apply(c||this,arguments)}}}function ba(a){return function(b,c,d,f){var e=q(arguments);return k(c)?Q(b,v,c)[a]():3>e.length&&!e.some(k)?la(b,c,a):k(d)?Q(b,c,d)[a]():Q(b,c,f,d)[a]()}}function ca(a){x(a)||R(Object.getOwnPropertyNames(Array.prototype),"length").map(function(b){a[b]=Array.prototype[b]});a.on=function(b,c){return w(b,a,c)};a.css=function(b){return g.css(a,b)};a.addClass=function(b){a.map(function(a){a.classList.add(b)});
...
element.setAttribute(b,c||""):l(b)?b.includes("=")||b.includes("&")?b.split("&").forEach(function(a){a=a.split("=");t(a[1])?element.setAttribute(a[0],a[1]):element.setAttribute(a[0],"")}):element.setAttribute(b,""):n(b)&&I(b,function(a,b){element.setAttribute(b,a)})});return a};a.append=function(){y(arguments,function(b){a.map(function(a){a.appendChild((h.Node(val)?val:M(val)).cloneNode(!0))})});return a};a.appendTo=function(b,c){a.map(function(a){l(a)&&(a=B(b,c));h.Node(a)&&a.appendChild(a)});return a};
a.prepend=function(){y(arguments,function(b){a.map(function(a){a.insertBefore((h.Node(b)?b:M(b)).cloneNode(!0),a.firstChild)})});return a};a.hide=function(){return a.css({display:"none"})};a.show=function(){return a.css({display:""})};a.pick=function(b){if(h.int(b)&&t(a[b]))return r(a[b]);if(a.includes(b))return r(b)};return a}function da(a,b){a=b.isInput?"value":a;return function(){if(!arguments.length)return b[a];b[a].length&&(b[a]="");g.flatten(arguments).map(function(c){h.Node(c)?b.append(c):
b[a]+=k(c)?c.call(b):c});return b}}function ma(a,b,c){E(this,a,{set:b,get:c})}function U(a,b){function c(b){return function(c,d){return(d?V:w)(b,a,c)}}l(a)&&(a=B(a,b));if(1==a._DOMM)return a;a._DOMM=!0;a.isInput=h.Input(a);a.state||(a.state=N());a.newSetGet=ma;a.newSetGet("colorAccent",function(b){a.hasAttr("color-accent")&&k(b)&&b(a.getAttr("color-accent"))});a.html=da("innerHTML",a);a.Text=da("textContent",a);a.bind=function(b){if(!b.includes(".")){if(t(v[b]))a.html(v[b]);else{var c=a.html();c&&
g.setDeep(v,b,c)}a.isInput&&a.SyncInput(v,b,function(a){P("[bind="+b+"]",function(b){void 0!=a&&b.html(a)})});return a}var d=L(b);if(!v[d[0]])g.modelInit(d[0]).then(function(b){var c=b;d=q(d,1);d.map(function(f){if(f in c){var d=c.get(f);h.Def(d)&&d.isObservable?c=d:f===ea(f)&&(a.html(d),a.state.binder=c.on("$uberset:"+f,a.html),a.isInput&&a.SyncInput(c,f))}else b.set(f,a.html()),a.state.binder=b.on("$uberset:"+f,a.html),a.isInput&&a.SyncInput(b,f)})});else if(n(v[d[0]])){var c=v[d[0]],S=W(q(d,1)),
k=g.getDeep(c,S);h.Def(k)?a.html(k):g.setDeep(c,S);a.isInput&&a.SyncInput(c,S,function(a){void 0!=a&&P("[bind="+b+"]",function(b){b.html(a)})})}return a};a.unbind=function(b){a.state.binder&&(a.state.binder.off(),delete a.state.binder)};a.lifecycle={inserted:function(b){return a.state.once("attached",function(c){b.call(a,a)})},created:function(b){return a.state.once("created",function(c){b.call(a,a)})},destroyed:function(b){return a.state.once("destroyed",function(c){b.call(a,a)})},attr:function(b,
c){k(b)&&(c=b);return a.state.on("attr"+(l(b)?":"+b:""),c.bind(a))}};a.replace=function(b){a.parentNode.replaceChild(b,a);return a};a.clone=function(b){return U(a.cloneNode(void 0==b?!0:b))};a.importview=function(b,c){var d=a.hasAttr("cache-view");if(d){var g=localStorage.getItem(b);if(!fa(g)){a.html(g);return}}fetch(b,c||{mode:"cors",credentials:"same-origin"}).then(function(c){c.ok?c.text().then(function(c){d&&localStorage.setItem(b,c);a.html(c)}):console.warn("<"+a.localName+"> : unable to import view - "+
b)})};a.append=function(){var b=r.frag();g.flatten(arguments).map(function(a){h.Node(a)?b.appendChild(a):b.innerHTML+=a});a.appendChild(b);return a};var d=a.prepend.bind(a);a.prepend=function(){var b=r.frag();g.flatten(arguments).map(function(a){h.Node(a)?b.appendChild(a):b.innerHTML+=a});k(d)?d(b):a.insertBefore(b,a.firstChild);return a};a.appendTo=function(b,c){l(b)&&(b=B(b,c));h.Node(b)&&b.appendChild(a);return a};a.prependTo=function(b,c){l(b)&&(b=B(b,c));h.Node(b)&&b.insertBefore(a,b.firstChild);
return a};a.modify=function(b){b.call(a,a);return a};a.on=function(b,c){return w(b,a,c)};a.emit=a.state.emit;a.Click=c("click");a.Input=c("input");a.DoubleClick=c("dblclick");a.Focus=c("focus");a.Blur=c("blur");a.Keydown=c("keydown");a.Mousemove=c("mousemove");a.Mousedown=c("mousedown");a.Mouseup=c("mouseup");a.Mouseover=c("mouseover");a.Mouseout=c("mouseout");a.Mouseenter=c("mouseenter");a.Mouseleave=c("mouseleave");a.onScroll=function(b,c){return g.onScroll(a,b,c)};a.Hover=function(b){var c=[],
d=!1;c.push(w("mouseenter,mouseover",a,function(a,c){!1===d&&b(d=!0,a,c)}));c.push(w("mouseleave,mouseout",a,function(a,c){!0===d&&b(d=!1,a,c)}));return{off:function(){c=c.map(function(a){return a.off()});return this},on:function(){c=c.map(function(a){return a.on()});return this}}};a.css=function(b,c){return g.css(a,b,c)};a.gotClass=function(){return q(arguments).every(function(b){return a.classList.contains(b)})};a.addClass=function(){y(arguments,function(b){a.classList.add(b)});return a};a.stripClass=
function(){y(arguments,function(b){a.classList.remove(b)});return a};a.toggleClass=function(b,c){h.Bool(c)||(c=a.gotClass(b));a[(c?"strip":"add")+"Class"](b);return a};a.stripAttr=function(){y(arguments,a.removeAttribute.bind(a));return a};a.hasAttr=function(){return l(arguments[0])?a.hasAttribute(arguments[0]):q(arguments).every(a.hasAttribute)};a.setAttr=function(b,c){t(c)?a.setAttribute(b,c||""):l(b)?b.includes("=")||b.includes("&")?b.split("&").forEach(function(b){t(b.split("=")[1])?a.setAttribute(b.split("=")[0],
b.split("=")[1]):a.setAttribute(b.split("=")[0],"")}):a.setAttribute(b,""):n(b)&&I(b,function(b,c){a.setAttribute(c,b)});return a};a.getAttr=a.getAttribute;a.attr=function(b,c){return l(b)&&!t(c)?a.getAttr(b):a.setAttr(b,c)};a.prop=a.hasAttr;a.toggleAttr=function(b,c,d){a[((h.Bool(c)?!c:a.hasAttr(b))?"strip":"set")+"Attr"](b,c);return d?a.hasAttr(b):a};a.remove||(a.remove=function(){a.parentNode.removeChild(a)});a.removeAfter=function(b){setTimeout(a.remove.bind(a),b||5E3);return a};E(a,"Siblings",
{get:function(){return R(a.parentNode.children,a).filter(F)}});a.getRect=a.getBoundingClientRect;a.newSetGet("Width",function(b){a.style.width=b},function(){return a.getRect().with});a.newSetGet("Height",function(b){a.style.height=b},function(){return a.getRect().height});a.move=function(b,c,d){!0===d?a.style.transform="translateX("+b+"px) translateY("+c+"px)":(a.top=c+"px",a.left=b+"px")};a.query=function(b){return B(b,a)};a.queryAll=function(b){return G(b,a)};a.next=function(b,c){var d=q(a.parentNode.children),
g=d.indexOf(a)+1;return d[g]?c?r(d[g]):d[g]:b?c?r(d[0]):d[0]:null};a.previous=function(b,c){var d=q(a.parentNode.children),g=d.indexOf(a)-1;return d[g]?c?r(d[g]):d[g]:b?c?r(d[d.length-1]):d[d.length-1]:null};a.isInput&&(a.SyncInput=function(b,c,d){return g.SyncInput(a,b,c,d)},a.disconectInputSync=function(){return g.disconectInputSync(a)});a.observe=function(b,c,d){l(d)||(d="MutObserver");a[d]=new MutationObserver(function(a){a.map(function(a){b(a,a.type,a.target,a.addedNodes,a.removedNodes)})});
a[d].observe(a,c||{attributes:!0,childList:!0,subtree:!0});return a};a.unobserve=function(b){l(b)||(b="MutObserver");t(a[b])&&(a[b].disconnect(),delete a[b]);return a};return a}function r(a,b,c){if(l(a)&&(a=c?B(a,b):G(a,b),h.NodeList(a))){if(1<a.length)return ca(a);1==a.length&&(a=a[0])}return h.Node(a)?a._DOMM?a:U(a):h.NodeList(a)?ca(a):u}function ga(a,b,c,d,f){if(g.Directives.has(b)){var e=g.Directives.get(b);f&&c!=d?(a=r(a),h.Set(a.state.directives)||(a.state.directives=new Set),a.state.directives.has(b)?
e.update&&e.update.call(a,a,c,f):(a.state.directives.add(b),e.bind.call(a,a,c))):!f&&e.unbind&&e.unbind.call(a,a,c,d)}a.state&&(a.state.emit("attr",b,c,d,f),a.state.emit("attr:"+b,b,c,d,f))}function ha(){ia=!0;g.notifier.emit("ready")}var ia=!1,m=navigator.userAgent,ja=void 0,H=m.match(/(opera|chrome|safari|firefox|msie)\/?\s*(\.?\d+(\.\d+)*)/i);H&&null!==(ja=m.match(/version\/([\.\d]+)/i))&&(H[2]=ja[1]);var H=(H?[H[1],H[2]]:[navigator.appName,navigator.appVersion,"-?"]).join(" "),q=function(a,b){return a.slice?
a.slice(b||0):Array.prototype.slice.call(a,b||0)},m=function(a){return function(){for(var b=arguments.length,c=Array(b),d=0;d<b;d++)c[d]=arguments[d];return 1<=c.length&&c.every(a)}},ea=function(a){return a[a.length-1]},R=function(a,b){b=a.indexOf(b);return-1<b?a.splice(b,1):a},ka=function(a){return Array.isArray(a)?a:"undefined"!=typeof a.length?Array.from(a):[a]};new Event("destroy");var E=Object.defineProperty,Z=Object.getOwnPropertyDescriptor,t=m(function(a){return"undefined"!==typeof a}),fa=
m(function(a){return null===a}),k=function(a){return"function"===typeof a},l=function(a){return"string"===typeof a},n=function(a){return"[object Object]"===toString.call(a)},F=function(a){return a.toString().includes("HTML")},x=Array.isArray,X=function(){return ia||"complete"==p.readyState},na=function(){},Y=p.head,oa=/^((([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+(\.([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+)*)|((\x22)((((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(([\x01-\x08\x0b\x0c\x0e-\x1f\x7f]|\x21|[\x23-\x5b]|[\x5d-\x7e]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(\\([\x01-\x09\x0b\x0c\x0d-\x7f]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]))))*(((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(\x22)))@((([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.)+(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))$/i,
...
[b];l(a)&&a.includes(",")&&(a=a.split(","));x(a)||(a=[a]);var e=function(a){return c(a,a.target,b)};E(f,"Type",{set:function(b){ehdl.off();a=b.includes(",")?b.split(","):b;x(a)||(a=[a]);ehdl.on()},get:function(){return a},enumerable:!0});f.on=function(){b.map(function(b){a.map(function(a){b.addEventListener(a,e)})});f.state=!0;return f};f.off=function(){b.map(function(b){a.map(function(a){b.removeEventListener(a,e)})});f.state=!1;return f};f.once=function(){e=function(a){c(a,a.target,b);f.off();f.state=
!1};return f.on()}}},w=ba("on"),V=ba("once"),ta="Click Input DoubleClick Focus Blur Keydown Mousemove Mousedown Mouseup Mouseover Mouseout".split(" "),z={handles:new Map,hasTag:function(a){return z.handles.has(a.toLowerCase())},attached:function(a){var b=z.handles.get(a.tagName.toLowerCase());b.attached&&b.attached.call(a,a)},destroyed:function(a){var b=z.handles.get(a.tagName.toLowerCase());b.destroyed&&b.destroyed.call(a,a)},created:function(a){var b=z.handles.get(a.tagName.toLowerCase());b.created&&
b.created.call(a,a)}},u={element:function(a,b,c,d,f){var e=U(p.createElement(a));n(b)&&(c=b,b=void 0);void 0!=b&&e.html(b);if(n(c)||l(c))n(c)&&Object.keys(c).forEach(function(a){k(c[a])&&(ta.some(h.eq(a))?function(){var b=c[a];"DoubleClick"==a?a="dblclick":a=a.toLowerCase();e[a+"handle"]=w(a,e,function(){b.apply(e,arguments)});delete c[a]}():"created"===a&&(k(c[a])&&c[a],e.state.emit("created"),delete c[a]))}),e.setAttr(c);void 0!=d&&(h.Bool(d)?f=d:e.setAttr(d));f&&(e=e.outerHTML);F(e)&&z.hasTag(e.tagName)&&
z.created(e);return e},frag:function(a){var b=void 0;l(a)&&(b=M(a));h.Node(b)||(b=p.createDocumentFragment());h.Node(a)&&b.appendChild(a);return b},img:function(a,b,c){return u.element("img","",c,{src:a,alt:b})},input:function(a,b){n(a)&&(b=a,a="text");return u.element("input","",b,{type:a||"text"})},list:function(a,b,c){var d="";h.Arrylike(b)&&y(b,function(a){l(a)?d+=u.element("li",a).outerHTML:n(b)&&(d+=u.element("li",a.inner,a.attr).outerHTML)});return u.element(a,d,c)},a:function(a,b,c){return u.element("a",
b,c,"href="+a)},script:function(a,b,c,d,f){var e=u.element("script","",b,{type:"text/javascript"});if("src="===a.slice(0,4))return e.setAttr(a);k(d)&&(e.onload=function(){e.removeAttribute("initx");d()},b=g.randomInt(1E3),e.setAttribute("initx",b),a+="\ndocument.head.querySelector('script[initx=\""+b+"\"]').dispatchEvent(new UIEvent('load'));\n");1==c&&(e.defer=0!=c);1==f?e.text=a:e.src=g.URLfrom(a,{type:"text/javascript"});return e}};"table td th tr article aside ul ol li h1 h2 h3 h4 h5 h6 div span pre code section button br label header i style nav menu main menuitem".split(" ").map(function(a){u[a]=
function(b,c,d){return u.element(a,b,c,d)}});r=T(r,u);v.Proxy&&(r=new Proxy(r,{get:function(a,b){return a.hasOwnProperty(b)?a[b]:u.hasOwnProperty(b)?u[b]:function(a,d,f,e){return u.element(b,a,d,f,e)}}}));var g={notifier:N(),arrDiff:function(a,b,c){var d=b.filter(function(b){if(!a.includes(b))return b}),f=a.filter(function(a){if(b.includes(a))return a}),e=g.omit(f.concat(d),void 0);if(k(c)&&!h.empty(e))c(a,b,d,f,e);else return{added:d,same:f,diff:e,arr:a,arrb:b}},deglove:function(a){return h.Arraylike(a)&&
1==a.length?a[0]:a},last:ea,first:function(a){return a[0]},removeFrom:R,slice:q,cutdot:L,joindot:W,dffstr:M,toArr:ka,toInt:function(a){l(a)&&(a=Number(a));return isNaN(a)?0:0!==a&&isFinite(a)?(0<a?1:-1)*Math.floor(Math.abs(a)):a},observable:J,eventsys:N,dom:r,query:B,queryAll:G,queryEach:P,forEach:I,map:y,on:w,once:V,is:h,has:function(a,b,c){if(h.Arraylike(a))return q(a)[c?"some":"every"](a.includes.bind(a));if(n(a))return Object.prototype.hasOwnProperty.call(a,b);if(h.Set(a)||h.Map(a))return a.has(b)},
curry:C,concatObjects:T,UnHTML:function(a){return a.replace(/<script[^>]*?>.*?<\/script>/gi,"").replace(/<style[^>]*?>.*?<\/style>/gi,"").replace(/<![\s\S]*?--[ \t\n\r]*>/gi,"")},sameArray:function(a,b){var c=a.length;if(c!==b.length)return!1;for(;c--;)if(a[c]!==b[c])return!1;return!0},array:function(a){var b=[],c=q(arguments,1);if(1==c.length)for(;0<a;a--)b.push(k(c[0])?c[0]():c[0]);else for(;0<a;a--)b.push(g.array(c.length,c));return b},getAllKeys:function(a){var b=[];do b=b.concat(Object.getOwnPropertyNames(a));
...
onScroll:function(a,b,c){return w("wheel",a,function(a){c&&a.preventDefault();b(1>a.deltaY,a)})},get WhenReady(){return new Promise(function(a,b){if(X())return a();var c=setTimeout(function(){X()||b("loading took too long loaded with errors :(")},5500);g.notifier.once("ready",function(){clearTimeout(c);a()})})},model:function(a,b){l(a)&&n(b)&&!t(g.Models[a])&&(b=J(b),k(b.init)&&b.init.call(b,b),g.Models.set(a,b),g.Models.emit(a,b),b.load&&g.WhenReady.then(b.load.bind(b)));return new Promise(function(a,
d){b&&b.isObservable?a(b):d(Error("Crafter : An Error Occured with creating the ${name} Model"))})},modelInit:function(a,b){k(b)&&(void 0!=g.Models[a]?b.call(g,g.Models[a]):g.Models.once(a,function(a){b.call(g,a)}));return new Promise(function(b){void 0!=g.Models[a]?b(g.Models[a]):g.Models.once(a,function(a){b(a)})})},M:function(a,b){a=L(a);var c=a[0];if(t(g.Models[c]))return c=g.Models[c],1==a.length?c:g[(t(b)?"set":"get")+"Deep"](c,W(a.slice(1)),b)},directive:function(a,b){!g.Directives.has(a)&&
n(b)&&k(b.bind)&&(g.Directives.set(a,b),g.WhenReady.then(function(){P("["+a+"]",function(c){c=r(c);c.hasAttr(a)&&(h.Set(c.state.directives)||(c.state.directives=new Set),c.state.directives.has(a)||(c.state.directives.add(a),b.bind.call(c,c,c.getAttr(a))))})}))},camelDash:function(a){return a.replace(/([a-z])([A-Z])/g,"$1-$2").toLowerCase()},formatBytes:function(a,b){if(0==a)return"0 Bytes";var c=Math.floor(Math.log(a)/Math.log(1E3));return(a/Math.pow(1E3,c)).toPrecision(b+1||3)+" "+"Bytes KB MB GB TB PB EB ZB YB".split(" ")[c]},
...
"attr"].every(h.eq(e))&&("css"==e.toLowerCase()?g.addCSS(b[e]):E(a,e,Z(b,e)));k(b.attr)&&a.lifecycle.attr(b.attr);a.ComponentInstantiated=!0},attached:function(a){a.__DOMM||(a=r(a));a.ComponentInstantiated||c.created.call(a,a);k(b.inserted)&&b.inserted.call(a,a);a.ComponentHandled=!0},destroyed:function(a){k(b.destroyed)&&b.destroyed.call(a,a)}};g.Components.add(a);z.handles.set(a,c);g.WhenReady.then(function(){G(a).map(function(a){a.ComponentHandled||z.attached(a)})})},SyncInput:function(a,b,c,d){l(a)&&
...
!t(c)?e:c),k(a)?a():a);return e},off:function(){clearInterval(e.interval);return e}};if(!0===d||!0===c)g.onTabChange(function(a){e[a?"on":"off"]()});return{v:e.on()}}();if("object"===("undefined"===typeof f?"undefined":_typeof(f)))return f.v}}};(new MutationObserver(function(a){a.map(function(a){0<a.removedNodes.length&&y(a.removedNodes,function(a){F(a)&&(a.state&&a.state.emit("destroyed",a),z.hasTag(a.tagName)&&z.destroyed(a))});0<a.addedNodes.length&&y(a.addedNodes,function(a){F(a)&&(a.state&&a.state.emit("attached",
a),z.hasTag(a.tagName)&&!a.ComponentHandled&&z.attached(a));a.attributes&&y(a.attributes,function(b){g.Directives.has(b.name)&&ga(a,b.name,b.value,"",!0)})});"attributes"==a.type&&F(a.target)&&"style"!=a.attributeName&&ga(a.target,a.attributeName,a.target.getAttribute(a.attributeName),a.oldValue,a.target.hasAttribute(a.attributeName))})})).observe(p,{attributes:!0,childList:!0,subtree:!0});Y.appendChild(r.style("","crafterstyles"));m=function(a){return function(){g.tabActive=a;g.notifier.emit("tabChange",
