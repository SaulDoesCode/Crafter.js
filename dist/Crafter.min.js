...
F(e)&&z.hasTag(e.tagName)&&z.created(e);return e},frag:function(a){var b=void 0;l(a)&&(b=M(a));h.Node(b)||(b=p.createDocumentFragment());h.Node(a)&&b.appendChild(a);return b},img:function(a,b,c){return u.element("img","",c,{src:a,alt:b})},input:function(a,b){n(a)&&(b=a,a="text");return u.element("input","",b,{type:a||"text"})},list:function(a,b,c){var d="";h.Arrylike(b)&&y(b,function(a){l(a)?d+=u.element("li",a).outerHTML:n(b)&&(d+=u.element("li",a.inner,a.attr).outerHTML)});return u.element(a,d,
