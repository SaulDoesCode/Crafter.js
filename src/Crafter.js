...
(function (doc, root) {
    ...
    on('blur', TabChange(false)); on('focus', TabChange(true));

    Craft.curry.to = Craft.curry((arity, fn) => makeFn(fn, [], arity)); Craft.curry.adaptTo = Craft.curry((num, fn) => Craft.curry.to(num, function (context) {
